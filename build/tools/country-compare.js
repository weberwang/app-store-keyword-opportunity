...
export function registerCountryCompareTools(server) {
    server.tool("compare_countries", "对一组关键词在多个国家/地区并发打分，找出机会最大的市场。", {
        ...
        try {
            ...
            const countryList = countries
                ...
                .filter(Boolean);
            if (!termList.length)
                return err("请提供至少一个关键词");
            if (!countryList.length)
                return err("请提供至少一个国家代码");
