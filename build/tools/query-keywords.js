...
export function registerQueryKeywordTools(server) {
    server.tool("query_keywords", "从本地快照文件查询、筛选关键词。支持模糊搜索和多维度过滤。", {
        file: z
            .string()
            .optional()
    ...
    }, async ({ file, q, min_opportunity, max_competition, min_demand, include, exclude, sort_by, limit, }) => {
        try {
