export declare const discoveryModes: readonly ["trend", "keyword", "replacement"];
export type DiscoveryMode = (typeof discoveryModes)[number];
export declare const evidenceDimensions: readonly ["demand", "competition", "marketGap", "painIntensity", "monetizationPotential", "trendMomentum", "regionalFit", "supplyFreshness", "replacementPressure", "implementationFeasibility", "risk"];
export type EvidenceDimension = (typeof evidenceDimensions)[number];
export declare const decisionTiers: readonly ["pursue-now", "validate-next", "monitor", "discard"];
export type DecisionTier = (typeof decisionTiers)[number];
export declare const marketSignalSources: readonly ["apple-public", "aso-provider", "community", "trend", "first-party", "imported"];
export type MarketSignalSource = (typeof marketSignalSources)[number];
export declare const marketSignalEntityKinds: readonly ["keyword", "app", "topic"];
export type MarketSignalEntityKind = (typeof marketSignalEntityKinds)[number];
export declare const marketSignalMetrics: readonly ["demand-volume", "demand-durability", "keyword-volume", "keyword-difficulty", "competition-density", "ranking-velocity", "chart-momentum", "trend-momentum", "review-rating", "review-volume", "complaint-intensity", "supply-staleness", "paid-share", "price-point", "download-estimate", "revenue-estimate", "community-intent", "switching-intent", "entry-feasibility"];
export type MarketSignalMetric = (typeof marketSignalMetrics)[number];
export declare const highValueDimensions: readonly ["demandDurability", "supplyWeakness", "monetizationEvidence", "entryFeasibility", "evidenceConfidence"];
